  ...
  return (
    <div className="p-8 max-w-md mx-auto text-black mt-10 bg-white shadow-md rounded">
      ...
      <form onSubmit={handleUpdate}>
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2">ID Prodi (Tidak dapat diubah)</label>
          <input type="text" className="w-full px-3 py-2 border rounded bg-gray-100"
            value={id} disabled />
        </div>
        <div className="mb-4">
          <label className="block text-gray-700 text-sm font-bold mb-2">Nama Prodi</label>
        ...
        <div className="mb-6">
          ...
          <input type="text" className="w-full px-3 py-2 border rounded"
            required value={fakultas} onChange={(e) => setFakultas(e.target.value)} />
        </div>
